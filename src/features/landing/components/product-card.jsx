...
const ProductCard = ({ product }) => {
  ...
  return (
    <div data-testid="product-card" className="flex flex-col gap-6 rounded-3xl bg-white/90 p-6 text-gray-900 shadow-2xl shadow-rose-900/10 transition hover:-translate-y-1 hover:shadow-rose-900/20">
