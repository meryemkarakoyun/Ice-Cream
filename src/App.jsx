...
const App = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-linear-to-br from-[#800D1D] via-[#B83228] to-[#DC5236] text-white">
      <ToastContainer
      ...
      <div className="pointer-events-none absolute -bottom-32 right-[-5%] h-96 w-96 rounded-full bg-[#DC5236]/25 blur-[140px]" />
